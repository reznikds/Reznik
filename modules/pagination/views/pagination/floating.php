...
<p class="pagination">
	...
	<?php if ($previous_page !== FALSE): ?>
		<a href="<?php echo HTML::chars($page->url($previous_page)) ?>" rel="prev"><?php echo __('Пред.') ?></a>
	<?php else: ?>
		<?php echo __('Пред.') ?>
	<?php endif ?>
	...
	<?php if ($next_page !== FALSE): ?>
		<a href="<?php echo HTML::chars($page->url($next_page)) ?>" rel="next"><?php echo __('След.') ?></a>
	<?php else: ?>
		<?php echo __('След.') ?>
	<?php endif ?>
